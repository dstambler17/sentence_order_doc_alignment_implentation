...
resources='hostname=c*,mem_free=16G,ram_free=16G,gpu=1'
log_dir_base='/home/dstambl2/doc_alignment_implementations/data/logs/wmt16_dev/embed' #TODO: replace wmt16_dev with arg
...
do
    ...
    qsub -j y -o $log_dir_base/$domain_name.out \
        -l $resources \
        /home/dstambl2/doc_alignment_implementations/thompson_2021_doc_align/scripts/build_single_embeds.sh ${src_path} ${tgt_path} ${lang_code_src} ${lang_code_tgt} ${domain_name}
